...
if (content.includes(oldBrandsStr)) {
  content = content.replace(oldBrandsStr, restoredBrands);
  fs.writeFileSync(pagePath, content);
  console.log("Restored successfully!");
} else {
  console.log("Could not find the old brands string. Manual check needed.");
}
