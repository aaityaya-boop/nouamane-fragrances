...
export const metadata = {
  ...
  openGraph: {
    title: 'Parfums Arabes | NAY Parfums',
    description: 'Découvrez notre collection exclusive de parfums arabes. L\'essence de l\'Orient dans des flacons luxueux.',
    url: 'https://nayparfum.ma/parfums-arabes',
  },
  alternates: {
    canonical: 'https://nayparfum.ma/parfums-arabes',
  },
};
      ...
      <section className="relative pt-32 pb-12 lg:pt-48 lg:pb-16">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10 text-center relative z-10 flex flex-col items-center">
          ...
          <p className="mt-2 text-[13px] md:text-[15px] text-[#555] font-light max-w-xl leading-[2] tracking-widest uppercase mb-10">
            Découvrez notre collection exclusive de <span className="font-semibold text-[#111]">parfums arabes</span>. L'essence de l'Orient dans des flacons luxueux.
          </p>
