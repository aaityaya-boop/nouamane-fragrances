    ...
    <div className="space-y-8 max-w-6xl">
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <label className="text-xs font-bold uppercase tracking-wider text-neutral-700 flex items-center gap-1.5">
            <Sparkles size={14} className="text-amber-500" /> Modèles Haute Performance NAY Parfum (1-Clic)
          </label>
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full border ${
                  selectedTemplate === tpl.id ? 'bg-amber-400 text-neutral-950 border-amber-400' : tpl.badgeColor
                }`}>
                  {tpl.tag}
                </span>
                {selectedTemplate === tpl.id && <Check size={14} className="text-amber-400" />}
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          >
            <div className="bg-white border border-neutral-200/80 rounded-2xl p-6 shadow-sm space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full border border-neutral-200 rounded-xl p-3 text-sm font-medium focus:ring-2 focus:ring-neutral-900 focus:outline-none" 
                  />
                </div>
                ...
                <div>
                  ...
                  <select 
                    ...
                    className="w-full border border-neutral-200 rounded-xl p-3 text-sm font-medium bg-white focus:ring-2 focus:ring-neutral-900 focus:outline-none"
                  >
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <div className="text-[11px] text-neutral-500 space-x-1">
                    ...
                    <button 
                      ...
                      className="text-amber-700 font-mono font-semibold hover:underline"
                    >
                      {`{{first_name}}`}
                    </button>
                    <span>•</span>
                ...
                <textarea 
                  ...
                  className="w-full border border-neutral-200 rounded-xl p-3.5 text-sm font-medium focus:ring-2 focus:ring-neutral-900 focus:outline-none leading-relaxed"
                />
              </div>
            ...
            <div className="flex items-center gap-3">
              <button 
                ...
                className="inline-flex items-center gap-2 px-6 py-3 bg-neutral-950 hover:bg-neutral-900 text-amber-400 font-bold rounded-xl shadow-lg transition-all active:scale-95 disabled:opacity-50"
              >
                <Save size={18} />
        ...
        <div className="lg:col-span-5">
          <div className="sticky top-20 bg-gradient-to-b from-neutral-900 to-neutral-950 p-6 rounded-3xl border border-neutral-800 text-white shadow-2xl space-y-4">
            ...
            <div className="bg-neutral-950 rounded-2xl p-4 border border-neutral-800 space-y-3">
              ...
              <div className="bg-[#1f2c34] text-neutral-100 rounded-2xl rounded-tl-sm p-4 text-xs leading-relaxed space-y-2 border border-neutral-800/80 shadow-md">
                {channel === 'EMAIL' && subject && (
                  <div className="text-[11px] font-bold text-amber-400 pb-1 border-b border-neutral-700">
                    Objet : {subject}
                  </div>
                )}
            ...
            <div className="bg-neutral-800/40 rounded-xl p-3 border border-neutral-700/50 text-xs text-neutral-400 space-y-1">
              <p className="font-bold text-neutral-200">💡 Conseil d'optimisation :</p>
              <p>Les messages WhatsApp avec emoji et proposition de code direct ont un taux de conversion supérieur à 24% au Maroc.</p>
            </div>
          </div>
        </div>
