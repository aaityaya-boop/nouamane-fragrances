  ...
  return (
    <div className="p-6 md:p-10 max-w-[1600px] mx-auto text-neutral-900 space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-neutral-200">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-neutral-900">Parfums Master Copy</h1>
          <p className="text-[13px] text-neutral-500 mt-1">Gérez vos parfums d'inspiration et dupes de qualité ({products.length} au total).</p>
        </div>
        ...
        <div className="flex items-center gap-2.5">
          ...
          >
            <Plus size={14} /> Nouveau master copy
          </button>
        </div>
      </div>
            ...
            <div className="bg-white border-b border-neutral-200 px-6 sm:px-8 py-4 flex items-center justify-between sticky top-0 z-20">
              <div>
                <h2 className="text-lg font-bold text-neutral-900">
                  {editingProduct ? 'Modifier le produit' : 'Nouveau parfum master copy'}
                </h2>
