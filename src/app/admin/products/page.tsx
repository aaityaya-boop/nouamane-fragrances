  ...
  return (
    <div className="p-6 md:p-10 max-w-[1600px] mx-auto text-neutral-900 space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-neutral-200">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-neutral-900">Testeurs</h1>
          <p className="text-[13px] text-neutral-500 mt-1">Gérez votre catalogue de testeurs ({products.length} au total).</p>
        </div>
        ...
        <div className="flex items-center gap-2.5">
          ...
          >
            <Plus size={14} /> Ajouter un testeur
          </button>
        </div>
      </div>
      ...
      <div className="bg-white border border-neutral-200 rounded-2xl overflow-hidden shadow-2xs">
        <div className="p-3.5 border-b border-neutral-100 flex items-center gap-3 bg-white">
          ...
          <input 
            type="text" 
            placeholder="Rechercher un testeur par nom, marque ou SKU..." 
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-[13px]">
            <thead className="bg-neutral-50 border-b border-neutral-200 text-neutral-600 text-[11px] uppercase tracking-wider font-semibold">
              <tr>
                <th className="px-5 py-3">Testeur & SKU</th>
            ...
            <tbody className="divide-y divide-neutral-100">
              {isLoading ? (
                <tr>
                  <td colSpan={6} className="px-5 py-12 text-center text-neutral-400 text-xs">Chargement des testeurs...</td>
                </tr>
              ) : filteredProducts.length === 0 ? (
                <tr>
                  <td colSpan={6} className="px-5 py-12 text-center text-neutral-400 text-xs">Aucun testeur trouvé.</td>
                </tr>
              ) : (
