...
const MENU_ITEMS = [
  ...
  { href: '/admin/parfums-originaux', label: 'Parfums Originaux', icon: <Moon size={18} /> },
...
const MARKETING_ITEMS = [
  ...
  { href: '/admin/marketing/abandoned-carts', label: 'Paniers Abandonnés', icon: <ShoppingCart size={18} /> },
